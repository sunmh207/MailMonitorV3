...
<s:actionerror />
<s:actionmessage />
<html:pagetitle title="Continues Email Rule"/>
...
<table width="100%" class="table" cellpadding="0" cellspacing="0" align="center">
	<tr>
        ...
        <td class="td_edit" colspan="2">		
			Continues Mail Rule: If specific mail come a number of times in a period of time, the rule will be triggered.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td height="24" align="right" class="td_lable">Times</td>
        <td class="td_edit">		
			<s:textfield  name="rule.mailNumberThreshold" value="%{rule.mailNumberThreshold}" size="5"/> 	 
        </td>
    </tr>
	<tr>
